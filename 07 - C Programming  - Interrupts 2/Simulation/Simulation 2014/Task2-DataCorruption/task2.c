...
int main() {
    ...
    //**************************
    _T2IP = 5; //Interrupt priority = 5
    PR2 = 62500 - 1; //Period Register


    //**************************************************************
    // ALLOW / DISALLOW INTERRUPT NESTING
    //**************************************************************
    //_NSTDIS = 0;	// NSTDIS == 0, ENABLE nesting of interrupts
    _NSTDIS = 1; // NSTDIS == 1,  DISABLE nesting of interrupts
    //**************************************************************
    ...
    //GET READY - RESET TIMERS TO SOME CONTRIVED VALUES
    //(DESIGNED TO FORCE A RACE CONDITION!)
